...
def load_excel_data() -> Tuple[
    ...
    weekly_ret = pd.read_excel(config.DATA_FILE, sheet_name="Historic Weekly Returns", index_col=0)
    ...
    comb_data = pd.read_excel(config.FORECAST_FILE, sheet_name="Combination Forecast", index_col=0)
    ...
    Signal = pd.read_excel(config.FORECAST_FILE, sheet_name="Signal Scores", index_col=0).iloc[-1]
...
def main() -> None:
    ...
    benchmark = 'SP500'
    benchmark_ret, benchmark_weekly_rets = benchmark_rets(benchmark, config.FIVE_YEAR_AGO, config.TODAY, 252)
    ...
    (weekly_ret, tickers, weekly_cov, ann_cov, cov_df,
     ...
     bear_rets, bull_rets, mcap) = load_excel_data()
    ...
    w_min = 2 / config.MONEY_IN_PORTFOLIO
    ...
    w_msr = po.msr_2(rf_rate, comb_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_h, mcap_bnd_l)
    ...
    w_sortino = po.msr_sortino(rf_rate, comb_rets, weekly_ret.tail(52),
                            w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_h, mcap_bnd_l)
    ...
    w_mir = po.MIR(benchmark_ret, benchmark_weekly_rets, comb_rets, buy_flags, sell_flags, comb_score,
                   w_max, weekly_hist, ticker_ind, ticker_sec, mcap_bnd_h, mcap_bnd_l)
    ...
    w_msp = po.msp(comb_score, ann_cov, buy_flags, sell_flags, comb_rets,
                w_max, ticker_ind, ticker_sec, mcap_bnd_h, mcap_bnd_l)
    ...
    w_comb = po.comb_port(rf_rate, comb_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, weekly_ret, mcap_bnd_h, mcap_bnd_l, benchmark_ret, benchmark_weekly_rets)
    ...
    w_msr_bear = po.msr_2(rf_rate, bear_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_bear_h, mcap_bnd_bear_l)
    ...
    w_sortino_bear = po.msr_sortino(rf_rate, bear_rets, weekly_ret.tail(52), 
                                  w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_bear_h, mcap_bnd_bear_l)
    ...
    w_mir_bear = po.MIR(benchmark_ret, benchmark_weekly_rets, bear_rets, buy_flags, sell_flags, comb_score,
                     w_max, weekly_ret.tail(52), ticker_ind, ticker_sec, mcap_bnd_bear_h, mcap_bnd_bear_l)
    ...
    w_comb_bear = po.comb_port(rf_rate, bear_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, weekly_ret, mcap_bnd_bear_h, mcap_bnd_bear_l, benchmark_ret, benchmark_weekly_rets)
    ...
    w_msr_bull = po.msr_2(rf_rate, bull_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_bull_h, mcap_bnd_bull_l)
    ...
    w_sortino_bull = po.msr_sortino(rf_rate, bull_rets, weekly_ret.tail(52),
                                  w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, mcap_bnd_bull_h, mcap_bnd_bull_l)
    ...
    w_mir_bull = po.MIR(benchmark_ret, benchmark_weekly_rets, bull_rets, buy_flags, sell_flags, comb_score,
                     w_max, weekly_ret.tail(52), ticker_ind, ticker_sec, mcap_bnd_bull_h, mcap_bnd_bull_l)
    ...
    w_comb_bull = po.comb_port(rf_rate, bull_rets, ann_cov, w_max, buy_flags, sell_flags, comb_score, ticker_ind, ticker_sec, weekly_ret, mcap_bnd_bull_h, mcap_bnd_bull_l, benchmark_ret, benchmark_weekly_rets)
    ...
    write_excel_results(config.FORECAST_FILE, sheets_to_write)
