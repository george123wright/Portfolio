...
def main() -> None:
    ...
    tickers = [
        "1211.HK", "ACHR", "AMZN", "APD", "ASTS", "ASX", "AV.L", "BA", "BA.L", "BABA", "BATS.L", "BBAI",
        "BLDR", "BLZE", "BNP.PA", "BNTC", "BP.L", "BBD-B.TO", "BT-A.L", "BUR", "BUSE", "C", "CCO.TO", "CELH", "CNQ.TO", "COP", "COHR", "CPNG", "CRWD", "COST", "CVX", "CYBR", "CZR",
        ...
        "IAG.L", "IDXX", "IMI.L", "INVZ", "JD.L", "JPM", "KO", "KBR", "LH", "LRN", "LMP.L", "LOVE", "LUNR", "MCD", "MELI", "META", "MGM", "MGNI", "MNG.L", "ML.PA", "MSFT", 
        "MTZ", "NEE", "NG.L", "NUE", "NVDA", "NOVO-B.CO", "ORCL", "OUST", "PLTR", "PSN.L", 
        "QNST", "REL.L", "RGTI", "RR.L", "RY.TO", "SAN.MC", "SHIP", "SMCI", "STE", "SU.TO", "TBLA", "TDY", "TEM", "TEVA", 
        "TRMB", "TRMD", "TSCO.L", "TTD", "TTWO", "UBSG.SW", "UUUU", "VIRT", "VKTX",
        "W7L.L", "WFC", "WMT", "WPK.TO", "ZETA", "ZIM"
    ]    
   
    start_date = '2000-01-01'  
   
    data = download_data(tickers, start_date, config.TODAY)
    close = get_close_series(data, tickers)
    ...
    export_results(sheets_data, config.DATA_FILE)
